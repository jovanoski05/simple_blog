  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <div>
      ...
      <div>
        ...
        <div class="mt-2">
            <textarea id='password' name='password' class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" required></textarea>
        </div>
      </div>
      ...
      <div>
        ...
        <div class="mt-2">
            <textarea id='password_confirmation' name='password_confirmation' class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" required></textarea>
        </div>
      </div>
    ...
    <p style="text-align: center" class="mt-5">Already have an account? <a href="/login" class="text-blue-500 hover:underline">Log In</a></p>
  </div>
</div>
